...
Caf.defMod(module, () => {
  return Caf.importInvoke(
    ...
    (
      ...
      let CompileCache;
      require("chalk");
      return (CompileCache = Caf.defClass(
        ...
        function (CompileCache, classSuper, instanceSuper) {
          ...
          this.classGetter({
            ...
            compileCacheFilePathRoot: function () {
              let temp;
              return (temp = this._compileCacheFilePathRoot) != null
                ? temp
          ...
          this.getCompilerName = function (compiler) {
            return (
              (Caf.isF(compiler.getName) && compiler.getName()) || compiler.name
            );
          };
          ...
          this.fetch = function (cachedFileKey) {
            ...
            return (fileName = this.getFileName(cachedFileKey)) &&
              ...
              ? (cacheContents = (() => {
                ...
                this.dependenciesUnchanged(cachedFileKey, cacheContents.props)
                ? ((cacheContents.fromCache = true), cacheContents)
                : undefined
              : undefined;
          };
          this.dependenciesUnchanged = function (cachedFileKey, props) {
            return !Caf.find(
